...
r1 <- optimParamsDiscrete(rbeta(n = 1000, shape1 = 5, shape2 = 10, ncp = 2), family = family_list[[1]][c('package', 'family')], 
...
r2 <- optimParamsDiscrete(rbeta(n = 1000, shape1 = 30, shape2 = 10, ncp = 2), family = family_list[[1]][c('package', 'family')], 
                         family_info = info, debug_error=F, max_discrete_steps = 100, plot=T,
                         discrete_fast = FALSE, show_optim_progress = FALSE)
...
r3 <- optimParamsDiscrete(rnorm(n=1e6, mean=2, sd=0.5), family = family_list[[12]][c('package', 'family')],
