list(list(package = "DescTools", family = "Benf", family_info = list(
    lower = c(ndigits = 1), upper = c(ndigits = 2), accepts_float = c(ndigits = FALSE), 
    defaults = c(ndigits = 1), log = TRUE, discrete = TRUE, support_min = 1, 
    support_max = 9, supp_max_depends_on = c(ndigits = FALSE), 
    ...
    shape = TRUE), defaults = c(loc = 0, scale = 1, shape = 1
        ...
        ), supp_min_depends_on = c(loc = TRUE, scale = FALSE, 
        shape = FALSE))), list(package = "DescTools", family = "GenExtrVal", 
    ...
    shape = TRUE), defaults = c(loc = 0, scale = 1, shape = 0
        ...
        shape = FALSE))), list(package = "DescTools", family = "Gompertz", 
    family_info = list(lower = c(shape = -9, rate = 0.01), upper = c(shape = Inf, 
    rate = Inf), accepts_float = c(shape = TRUE, rate = TRUE), 
        defaults = c(shape = 1, rate = 1), log = TRUE, discrete = FALSE, 
        support_min = 0, support_max = Inf, supp_max_depends_on = c(shape = FALSE, 
        rate = FALSE), supp_min_depends_on = c(shape = FALSE, 
        rate = FALSE))), list(package = "DescTools", family = "Gumbel", 
    ...
    scale = Inf), accepts_float = c(loc = TRUE, scale = TRUE), 
        ...
        scale = FALSE))), list(package = "DescTools", family = "NegWeibull", 
    ...
    scale = FALSE), defaults = c(location = 0, scale = 1), log = FALSE, 
        ...
        ))), list(package = "DescTools", family = "RevWeibull", 
    family_info = list(lower = c(loc = -Inf, scale = 0.01, shape = 0.01
    ), upper = c(loc = Inf, scale = Inf, shape = Inf), accepts_float = c(loc = TRUE, 
    scale = TRUE, shape = TRUE), defaults = c(loc = 0, scale = 1, 
    shape = 1), log = TRUE, discrete = FALSE, support_min = -Inf, 
