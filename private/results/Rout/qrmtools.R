list(list(package = "qrmtools", family = "GEV", family_info = list(
    ...
    shape = FALSE))), list(package = "qrmtools", family = "GPD", 
    family_info = list(lower = c(shape = -Inf, scale = 8.32667268468867e-17
    ), upper = c(shape = 790.5, scale = Inf), accepts_float = c(shape = TRUE, 
    scale = TRUE), defaults = c(shape = 0.5, scale = 0.5), log = TRUE, 
    ...
    list(package = "qrmtools", family = "GPDtail", family_info = list(
        lower = c(threshold = -Inf, p.exceed = 0, shape = -Inf, 
        scale = 8.32667268468867e-17), upper = c(threshold = Inf, 
        ...
        p.exceed = FALSE, shape = FALSE, scale = FALSE))), list(
        package = "qrmtools", family = "Par", family_info = list(
            ...
            ), log = TRUE, discrete = FALSE, support_min = -10, 
