list(list(package = "CoSMoS", family = "burrIII", family_info = list(
    lower = c(scale = -Inf, shape1 = 8.32667268468867e-17, shape2 = 8.32667268468867e-17
    ...
    supp_max_depends_on = c(scale = FALSE, shape1 = FALSE, shape2 = FALSE
    ), supp_min_depends_on = c(scale = FALSE, shape1 = FALSE, 
    shape2 = FALSE))), list(package = "CoSMoS", family = "burrXII", 
    family_info = list(lower = c(scale = -Inf, shape1 = 8.32667268468867e-17, 
    shape2 = 8.32667268468867e-17), upper = c(scale = Inf, shape1 = Inf, 
    shape2 = 950.5), accepts_float = c(scale = TRUE, shape1 = TRUE, 
    shape2 = TRUE), defaults = c(scale = 0.5, shape1 = 0.5, shape2 = 0.5
    ...
    ), upper = c(scale = Inf, shape1 = Inf, shape2 = Inf), accepts_float = c(scale = TRUE, 
    ...
    shape = 8.32667268468867e-17), upper = c(scale = Inf, shape = 900.5
    ), accepts_float = c(scale = TRUE, shape = TRUE), defaults = c(scale = 0.5, 
