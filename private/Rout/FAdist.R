list(list(package = "FAdist", family = "gamma3", family_info = list(
    ...
    family = "gp", family_info = list(lower = c(shape = -Inf, 
    ...
    list(package = "FAdist", family = "lgamma3", family_info = list(
        ...
        scale = Inf, thres = 709), accepts_float = c(shape = TRUE, 
        ...
        scale = -Inf), upper = c(shape = Inf, scale = 710), accepts_float = c(shape = TRUE, 
        scale = TRUE), defaults = c(shape = 1, scale = 1), log = TRUE, 
        ...
        thres = -Inf), upper = c(shape = 801, scale = 711, thres = 9.99
        ...
        scale = -Inf, thres = -Inf), upper = c(shape = Inf, scale = 711, 
        ...
        thres = -Inf, shape = 0.0100000000000001), upper = c(scale = Inf, 
